...
- [x] Google OAuth credentials (Google Cloud Console + Supabase provider)
...
- [x] **Edad de la mascota visible**: calcular y mostrar la edad a partir de `birthdate` en la pet card y en la página pública.
